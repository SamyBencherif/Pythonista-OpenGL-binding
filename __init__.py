...
import math, numbers
from scene._scene_types import *
...
from scene._scene import stroke_weight, no_stroke, no_fill, no_tint, load_image, image
from scene._scene import background, rect, ellipse, fill, stroke, tint, get_image_path
from scene._scene import load_image_file, line, unload_image, image_quad, text
from scene._scene import triangle_strip
#size = _scene.size
